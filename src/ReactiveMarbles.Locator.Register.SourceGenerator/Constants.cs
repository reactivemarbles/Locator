...
internal static class Constants
{
    ...
    public const string ServiceLocatorInterfaceTypeName = "eactiveMarbles.Locator.IServiceLocator";
...
{{
    ...
    {{
        ...
        public static void SetupIOC(global::{NamespaceName}.{ServiceLocatorInterfaceTypeName} locator)
        {{
            SetupIOCInternal(locator);
        }}

        static partial void SetupIOCInternal(global::{NamespaceName}.{ServiceLocatorInterfaceTypeName} resolver);
    }}
